...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Tippe auf die linke und rechte Seite des Bildschirms,'
        action_text = 'um das Sechseck zu drehen.'
        score_text = 'Kombiniere 3+ Blöcke, um zu punkten!'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Verwende die rechte und linke Pfeiltaste,'
        action_text = 'um das Sechseck zu drehen.'
        score_text = 'Kombiniere 3+ Blöcke, um zu punkten!'
        fontSize = 27
    }
